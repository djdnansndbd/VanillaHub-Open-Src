                    ...
                    for _, v in pairs(workspace.PlayerModels:GetDescendants()) do
                        ...
                        if v.Name == "Owner" and tostring(v.Value) == giverName then
                            ...
                            if isStructure(p) then
                                ...
                                until not p.Parent
                                done = done + 1; setProgStructures(done, total)
                            end
                        end
                    end
                end)
                    ...
                    for _, v in pairs(workspace.PlayerModels:GetDescendants()) do
                        ...
                        if v.Name == "Owner" and tostring(v.Value) == giverName then
                            ...
                            if isFurniture(p) then
                                ...
                                until not p.Parent
                                done = done + 1; setProgFurniture(done, total)
                            end
                        end
                    end
                end)
            ...
            if truckCount > 0 then
                ...
                for _, v in pairs(workspace.PlayerModels:GetDescendants()) do
                    ...
                    if v.Name == "Owner" and tostring(v.Value) == giverName and v.Parent:FindFirstChild("DriveSeat") then
                        ...
                        truckDone = truckDone + 1; setProgTrucks(truckDone, truckCount)
                    end
                end
            ...
            if #items > 0 then
                ...
                for _, entry in ipairs(items) do
                    ...
                    if not (part and part.Parent) then
                        done = done + 1; setProgGifs(done, total); continue
                    end
                    ...
                    done = done + 1; setProgGifs(done, total)
                end
        ...
        if getWood() and butterRunning then
            ...
            if #items > 0 then
                ...
                for _, entry in ipairs(items) do
                    ...
                    if not (part and part.Parent) then
                        done = done + 1; setProgWood(done, total); continue
                    end
                    ...
                    done = done + 1; setProgWood(done, total)
                end
    ...
    batchTruckThread = task.spawn(function()
        ...
        for _, truckModel in ipairs(availableTrucks) do
            ...
            if not (truckModel and truckModel.Parent) then
                trucksDone = trucksDone + 1; setBatchTruckProg(trucksDone, #availableTrucks); continue
            end
            ...
            trucksDone = trucksDone + 1; setBatchTruckProg(trucksDone, #availableTrucks)
            task.wait(0.3)
        end
